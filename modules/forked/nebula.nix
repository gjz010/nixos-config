...
let
  ...
  cfg = config.gjz010.services.nebula;
            ...
            options = {
              ...
              listen.port = lib.mkOption {
                ...
                defaultText = lib.literalExpression ''
                  if (config.gjz010.services.nebula.networks.''${name}.isLighthouse ||
                      config.gjz010.services.nebula.networks.''${name}.isRelay) then
                    4242
                  else
                    0;
                '';
